...
const config = {
    ...
    scene: [BootScene, PreloaderScene, MainMenu, IntroStoryScene, IntroCharactersScene, IntroLevel1, Level1_Semaforo, IntroLevel2, Level2_Lonchera, Level3_Grupos, Level4_Decisiones, VideosScene]
};

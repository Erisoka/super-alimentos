export default class Level1_Semaforo extends Phaser.Scene {
    ...
    create() {
        ...
        // Creación y configuración de alimentos (Espala 0.25 HD con mayor separación horizontal)
        const manzana = this.add.image(150, 530, 'manzana').setScale(0.25).setDepth(10).setInteractive({ draggable: true });
        manzana.colorCorrecto = 'verde';

        const huevo = this.add.image(275, 530, 'huevo').setScale(0.25).setDepth(10).setInteractive({ draggable: true });
        ...
        const agua = this.add.image(525, 530, 'agua').setScale(0.25).setDepth(10).setInteractive({ draggable: true });
        agua.colorCorrecto = 'verde';

        const dulces = this.add.image(650, 530, 'dulces').setScale(0.25).setDepth(10).setInteractive({ draggable: true });

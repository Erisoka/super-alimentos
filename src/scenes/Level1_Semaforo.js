export default class Level1_Semaforo extends Phaser.Scene {
    ...
    create() {
        ...
        this.add.image(200, 530, 'manzana').setScale(0.15).setDepth(10);
        this.add.image(300, 530, 'huevo').setScale(0.15).setDepth(10);
        this.add.image(400, 530, 'pizza').setScale(0.15).setDepth(10);
        this.add.image(500, 530, 'agua').setScale(0.15).setDepth(10);
        this.add.image(600, 530, 'dulces').setScale(0.15).setDepth(10);
